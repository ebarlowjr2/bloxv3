...
export const AGENTS: AgentDef[] = [
  ...
  { key: 'ALEX', name: 'A.L.E.X.', subtitle: 'Administrative Logistics Executive', role: 'Operations', color: 'bg-emerald-500', live: false, tools: ['Google Calendar', 'Slack', 'Notion'] },
  {
    key: 'TESS',
    name: 'T.E.S.S.',
    subtitle: 'Ticketing & Escalation Support Specialist',
    role: 'Support',
    color: 'bg-orange-500',
    live: true,
    urlEnv: 'TESS_RELAY_URL',
    urlDefault: 'https://18.220.149.112/tess-api',
    bearerEnv: 'TESS_RELAY_BEARER',
    tools: ['gpt-5.4', 'Zendesk', 'Ticket triage', 'Draft replies'],
  },
